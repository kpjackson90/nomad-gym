...
class SingleCountry extends Component {
  renderCities() {
    ...
    return this.props.data.country.city.map(
      ({ id, city_name, gym, city_image }) => {
        const bgImg = { backgroundImage: `url("${city_image}")` };
        return (
  ...
  render() {
    ...
    const backImg = {
      backgroundImage: `url("${this.props.data['country'].country_image}")`
    };
